...
console.log("running query.process");
 ...
 // console.log("this.msg.querySelectionSetMemberWA_AR.length 20190915: "+this.msg.querySelectionSetMemberWA_AR.length);
   for (var j = 0; j < this.msg.querySelectionSetMemberWA_AR.length; j++) {queryResponseInit
...
// end of temporary paste to help with coding

console.log("listing this.msg.ZtMessageResponse_Array and end of query process in zt_server_query.js deleted temporarily 20210521");
for (i = 0; i < this.msg.ZtMessageResponse_Array.length; i++){
   //console.log(this.msg.ZtMessageResponse_Array[i].index+"-"+                      temp (del) 20210521
...
// 20200107 start of test of system message
// 20200206 temp (del)
  ...
  sys_msg_obj.setParameterValue("131131/21", "2", "select");
  sys_msg_obj.setParameterValue("131131/21", "3", "zt_server_query.js");  
  sys_msg_obj.setParameterValue("131131/21", "4", "this is the variable text for the test system message at ZtQuery.select");  
  sys_msg_obj.addLogEntryToMessage();  
// 20200206 end temp (del)
// 20200107 end of test of system message

    //  for (var j = 0; j < this.svr1.ZtObject_AR.length; j++) {
    //     var objx = this.svr1.ZtObject_AR[j];
    //     this.queryResponseObjectAdd(objx);
 ...
 console.log(resp_item_AR[n].id+"-"+resp_item_AR[n].parent_id+"-"+resp_item_AR[n].kindZTIC+"-"+resp_item_AR[n].kindCode+"-"+resp_item_AR[n].objZTIC+"-"+resp_item_AR[n].objCode);
                           ...
                           // end-get all values for object   20191106
