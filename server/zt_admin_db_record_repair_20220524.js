...
//var ds_com_address_ztic =     svrx.getCodeForNS(TabNamePrfx, "zinfinitree.com/address");
     ...
     // var send_time = svrx.time.now();
      ...
      var args = {
 data: { te_2_32: "DOC1",         // tab name prefix
         te_2_1: "9",  // object kind ztic  address ztic
         te_2_2: "2",                  // object kind code
         te_2_3: "1",   // object ztic ztic
         te_2_4: "206",                 // object code
         //te_2_5: "2",
         //te_2_6: "4",
         te_2_7: "9",  // object element ztic
         te_2_8: "5",                // object element code for next code in code range
         //te_2_9: "2",  // extended key definition ztic
         //te_2_10: "2",                // extended key definition code
         //te_2_11: "2",  // extended key value ztic
         //te_2_12: "1",                // extended key value code
         //te_2_17: "2",
         //te_2_18: "19",
         //te_2_19: "2",
         //te_2_20: "13",
         ...
         te_2_25: "",
         te_2_30: "",
         te_2_26: "5217829172.380784",  // timestamp
         te_2_31: "xxx" },
...
/////client.post("http://localhost:5001/ZtObjectDbRec/628d141cdfb6e06d1e9eecb9/remove", function (data, response) {
  client.post("http://localhost:5001/ZtObjectDbRec/update_oe_value", args, function (data, response) {
/////   // parsed response body as js object 
/////   //console.log(data);    //(del) 20210521
